...
public class JNative
{
    ...
    private final static Map<String, JNative> mLibs = new HashMap<String, JNative>();
    ...
    private native int nFindFunction(int libHandle, String funcPointer) throws NativeException;
...
//
    ...
    private final boolean loadLibrary() throws NativeException
    {
        synchronized (mLibs)
        {
            ...
            final JNative libDesc = mLibs.get(mDllName);
    ...
    public static final boolean isLibraryLoaded(String name)
    {
        synchronized (mLibs)
        {
            final JNative libDesc = mLibs.get(name);
...
//        throwClosed();
    ...
    public static int getCurrentModule() throws NativeException
    {
        ...
        if (currentHModule == 0)
        {
            ...
            try
            {
                currentHModule = Kernel32.LoadLibrary(JNative.DLL_NAME).getValue();
            }
