...
/**
 * $Id: MSG.java,v 1.15 2008/07/25 08:45:24 thubby Exp $
 *
 * <pre>
 * The C structure
 * typedef struct {
 ...
 */
public class MSG extends AbstractBasicData<MSG>
{
	 ...
	 *
	 */
	public MSG getValueFromPointer()
	{
		return this;
	}
	...
	/**
	 * @deprecated Seperated to org.xvolk.jnative.constants.winuser.WindowsConstants
	 */	
	@Deprecated public class WindowsConstants
	{
		/*
		 * ShowWindow() Commands
		 */
