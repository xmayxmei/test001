...
/**
 * <code>TodayOrderBiz<code> 当日委托查询
 *
 * @author Colin, Jimmy
 * @since Handsun v0.0.1(June 11,2014)
 *
 */
public class QueryTodayOrderBiz extends HSDataHandler{
	private static final String sFuncNo = FUNConstants.FUN_TODAY_ORDER;
