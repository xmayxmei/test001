...
public class HistoryWtBiz extends  DataHandler implements IBiz {
	private final static int iFuncNo = FUNConstants.FUN_SECU_LIST_WTLS_KH;
	@Override
	protected void buildField() {
		...
		asResponseField = new int[][] {
			...
			{FIDConstants.FID_WTSL,   FieldType.FieldString},//委托类型，0表示限价订单，其它见数据字典，FLDM=DDLX
			...
			{FIDConstants.FID_NODE,   FieldType.FieldString},// 操作站点
			{FIDConstants.FID_WTPCH,  FieldType.FieldString},//委托批次号
		};
		iFunID = iFuncNo;
	}
}
